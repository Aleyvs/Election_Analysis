...
county_options = [] 
county_votes = {}  ## key = county | value = votes cast for each county
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if(county_vote_count > winning_county_votes) and (county_percentage > winning_county_percentage):
    ...
    winning_county_summary = (
        ...
        f"----------------------------------------------\n"
        f"County with the Largest Turnout\n"
        f"----------------------------------------------\n"
        f"Largest County Turnout: {county_turnout}\n"
        f"-----------------------------------------------\n"
        f"Votes per Candidate\n\n"
